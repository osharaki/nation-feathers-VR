...
public class GeroBeam : MonoBehaviour {
    ...
    void Start () {
        ...
        HitObj = this.transform.Find("GeroBeamHit").GetComponent<GeroBeamHit>(); //added by osharaki
        ...
        SHP_Emitter = this.transform.Find("ShotParticle_Emitter").GetComponent<ShotParticleEmitter>(); //added by osharaki
        //Flash = this.transform.FindChild("BeamFlash").gameObject;
        Flash = this.transform.Find("BeamFlash").gameObject; //added by osharaki
	...
	void Update () {
        ...
        LR.startWidth = Width * BP.Scale; //added by osharaki
        LR.endWidth = Width * BP.Scale; //added by osharaki
        LR.startColor = BP.BeamColor; //added by osharaki
        LR.endColor = BP.BeamColor;//added by osharaki
