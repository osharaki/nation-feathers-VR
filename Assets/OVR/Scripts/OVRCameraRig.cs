...
public class OVRCameraRig : MonoBehaviour
{
    ...
    public Text main, left, center, right, tracker;  //added by osharaki
...
#region Unity Messages
	...
	private void Update()
	{
		...
		if (!useFixedUpdateForTracking)
			UpdateAnchors();
        if(main != null && left != null && center != null && right != null && tracker != null)
        {
            main.text = "Main" + transform.localRotation.ToString();  //added by osharaki
            left.text = "LeftEyeAnchor" + transform.Find("TrackingSpace/LeftEyeAnchor").rotation.ToString();  //added by osharaki
            center.text = "CenterEyeAnchor" + transform.Find("TrackingSpace/CenterEyeAnchor").rotation.ToString();  //added by osharaki
            right.text = "RightEyeAnchor" + transform.Find("TrackingSpace/RightEyeAnchor").rotation.ToString();  //added by osharaki
            tracker.text = "TrackerAnchor" + transform.Find("TrackingSpace/TrackerAnchor").rotation.ToString();  //added by osharaki
        }        
    }
	...
	{
        //Debug.Log("UpdateAnchors called");  //added by osharaki
		EnsureGameObjectIntegrity();
